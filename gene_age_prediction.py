...
parser.add_argument("-i", "--input", help="input filename",  type=argparse.FileType('r'), default=sys.stdin)
parser.add_argument("-s", "--supplementary", help="output supplementary file",type=argparse.FileType('w'), default=sys.stderr)
...
wr = csv.writer(args.output, delimiter='\t', lineterminator='\n')
